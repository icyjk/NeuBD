...
CREATE TABLE MATRICULA (CURSO_ACADEMICO INTEGER NOT NULL, ESTADO VARCHAR, FECHA_MATRICULA TIMESTAMP, LISTADO_ASIGNATURAS VARCHAR, NUEVO_INGRESO VARCHAR, NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR, EXPEDIENTES_NUM_EXPEDIENTE BIGINT NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTES_NUM_EXPEDIENTE))

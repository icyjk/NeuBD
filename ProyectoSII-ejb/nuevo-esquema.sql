...
CREATE TABLE ENCUESTA_GRUPOS_POR_ASIGNATURA (encuestas_FECHA_DE_ENVIO TIMESTAMP NOT NULL, CURSO_ACADEMICO VARCHAR NOT NULL, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID INTEGER NOT NULL, PRIMARY KEY (encuestas_FECHA_DE_ENVIO, CURSO_ACADEMICO, ASIGNATURA_REFERENCIA, GRUPO_ID))

...
CREATE TABLE CLASE (HORA_INICIO TIMESTAMP NOT NULL, DIA VARCHAR NOT NULL, HORA_FIN TIMESTAMP, ASIGNATURAS_REFERENCIA INTEGER, GRUPO_ID INTEGER NOT NULL, PRIMARY KEY (HORA_INICIO, DIA, GRUPO_ID))
...
CREATE TABLE MATRICULA (CURSO_ACADEMICO INTEGER NOT NULL, ESTADO VARCHAR, FECHA_MATRICULA TIMESTAMP, NUEVO_INGRESO VARCHAR, NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR, EXPEDIENTES_NUM_EXPEDIENTE BIGINT NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTES_NUM_EXPEDIENTE))

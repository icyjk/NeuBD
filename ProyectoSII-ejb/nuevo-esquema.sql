...
CREATE TABLE CLASE (HORA_INICIO TIME NOT NULL, DIA VARCHAR NOT NULL, HORA_FIN TIME, ASIGNATURAS_REFERENCIA INTEGER, GRUPO_ID INTEGER NOT NULL, PRIMARY KEY (HORA_INICIO, DIA, GRUPO_ID))
